...
export const STATES: StateData[] = [
  ...
  // ── 40 Additional States (alphabetical) ──────────────────────────────────
  {
    slug: "alabama",
    name: "Alabama",
    abbr: "AL",
    ...
    capital: "Montgomery",
    majorCities: ["Birmingham", "Montgomery", "Huntsville", "Mobile", "Tuscaloosa", "Hoover"],
    salesTax: "exempt",
    salesTaxNote: "Alabama exempts gold, silver, and platinum bullion and coins from sales tax under Code of Alabama §40-23-4(a)(59). The exemption covers bullion coins and bars sold primarily for metal content. No minimum purchase threshold.",
    deliveryDays: "2–3 business days",
    stateTip: "Alabama's full exemption has no minimum purchase threshold — even small silver coin purchases qualify. Standard bullion products like Eagles, Maples, and bar products from recognized refiners all clearly qualify under the state definition.",
    localAngle: "Alabama's conservative financial culture and growing suburban Birmingham economy drive consistent demand for gold and silver as tangible savings. Huntsville's aerospace and defense sector adds a professional demographic seeking hard-asset diversification.",
  ...
  },
  {
    ...
    capital: "Juneau",
    majorCities: ["Anchorage", "Fairbanks", "Juneau", "Sitka", "Ketchikan", "Kenai"],
    salesTax: "exempt",
    salesTaxNote: "Alaska has no statewide sales tax. While some municipalities levy local sales taxes, there is no state-level tax on precious metals purchases. Alaska is one of five US states with no statewide sales tax.",
    deliveryDays: "5–7 business days",
    stateTip: "Alaska orders ship via UPS or FedEx with insured service. Delivery to rural Alaska locations (outside Anchorage/Fairbanks metro areas) may require additional transit time or alternative carrier arrangements. Contact support for remote delivery quotes.",
    localAngle: "Alaska's resource economy and rugged self-reliance culture create strong interest in physical precious metals as a store of wealth outside the financial system. The Permanent Fund dividend culture means many Alaskans are accustomed to receiving and reinvesting resource-linked payments — gold and silver are a natural extension.",
    popularProducts: ["American Gold Eagles", "American Silver Eagles", "Gold Rounds (1 oz)", "Silver Monster Boxes"],
  },
  {
    slug: "arkansas",
    name: "Arkansas",
    ...
    capital: "Little Rock",
    majorCities: ["Little Rock", "Fort Smith", "Fayetteville", "Springdale", "Jonesboro", "Conway"],
    salesTax: "exempt",
    salesTaxNote: "Arkansas exempts gold, silver, and platinum bullion coins and bars from sales tax under Ark. Code Ann. §26-52-401(22). The exemption applies to coins and bullion sold primarily for metal content value.",
    deliveryDays: "1–2 business days",
    stateTip: "Arkansas is one of GoldBuller's fastest delivery destinations — shipping from Dallas to Little Rock and Fort Smith typically arrives next business day. Northwest Arkansas (Fayetteville/Springdale) receives within 1–2 business days.",
    localAngle: "Northwest Arkansas has seen explosive growth driven by the Walmart/Tyson Foods corporate ecosystem — producing a significant HNW professional population. Little Rock's banking and healthcare sector adds professional buyers seeking inflation protection. Arkansas has no state income tax on capital gains from gold sales over long holding periods under certain structures.",
    popularProducts: ["American Gold Eagles", "100 oz Silver Bars", "American Silver Eagles", "Gold Bars (1 oz)"],
  },
  {
    slug: "colorado",
    name: "Colorado",
    ...
    capital: "Denver",
    majorCities: ["Denver", "Colorado Springs", "Aurora", "Fort Collins", "Boulder", "Pueblo"],
    salesTax: "exempt",
    salesTaxNote: "Colorado exempts gold, silver, and platinum bullion and coins from sales tax under C.R.S. §39-26-703(1)(c). The exemption covers coins, bars, and ingots of precious metals sold primarily for metal content.",
    deliveryDays: "2–3 business days",
    stateTip: "Colorado's sales tax exemption is comprehensive — covering all standard bullion formats from all sovereign and private mints. The state's 4.40% base rate is fully avoided on qualifying precious metals purchases.",
    localAngle: "Colorado's tech and outdoor economy has created a large financially independent population in the Denver-Boulder corridor. Gold and silver purchases have grown significantly post-2020 as a hedge against the state's rising cost of living. Colorado is also one of the leading states for Bitcoin adoption — GoldBuller's Bitcoin payment option is popular among Colorado buyers converting crypto to physical gold.",
    popularProducts: ["American Gold Eagles", "PAMP Suisse Gold Bars", "American Silver Eagles", "Bitcoin-to-Gold conversions"],
  },
  {
    slug: "connecticut",
    name: "Connecticut",
    ...
    capital: "Hartford",
    majorCities: ["Bridgeport", "New Haven", "Stamford", "Hartford", "Waterbury", "Norwalk"],
    salesTax: "exempt",
    salesTaxNote: "Connecticut exempts precious metals bullion transactions over $1,000 from sales tax under Conn. Gen. Stat. §12-412(77). Purchases under $1,000 per transaction are subject to Connecticut's 6.35% sales tax rate. Standard 1 oz gold coins easily clear this threshold.",
    deliveryDays: "3–4 business days",
    stateTip: "Connecticut's $1,000 exemption threshold is cleared by a single fractional gold coin or any silver bar purchase of reasonable size. For silver-only buyers near the threshold, consider combining silver products in a single order to clear $1,000.",
    localAngle: "Connecticut's Fairfield County — home to Greenwich and Stamford — is one of the highest per-capita income counties in the US, hosting a significant concentration of hedge fund managers and financial professionals. This demographic is sophisticated in portfolio allocation and frequently uses gold as a core inflation hedge. Wire payments are standard for this buyer segment.",
    popularProducts: ["1 oz Gold Bars (PAMP)", "10 oz Gold Bars", "American Gold Eagles", "Platinum Eagles (IRA)"],
  },
  {
    slug: "delaware",
    name: "Delaware",
    ...
    capital: "Dover",
    majorCities: ["Wilmington", "Dover", "Newark", "Middletown", "Bear", "Smyrna"],
    salesTax: "exempt",
    salesTaxNote: "Delaware has no statewide sales tax — making all purchases, including gold and silver bullion, completely sales-tax-free. Delaware is one of five US states with no sales tax. Additionally, Delaware has no sales tax regardless of purchase amount.",
    deliveryDays: "3–4 business days",
    stateTip: "Delaware's no-sales-tax status is absolute — no minimum purchase, no per-transaction thresholds. Delaware residents buying gold and silver owe no sales tax at any level of purchase. Delaware also has no state income tax on most forms of investment income.",
    localAngle: "Delaware's corporate legal infrastructure makes it home to significant financial services and legal professionals based in the Wilmington area. Its proximity to Philadelphia and the broader Delaware Valley financial corridor creates a strong professional buyer demographic for larger gold and silver positions.",
    popularProducts: ["American Gold Eagles", "PAMP Suisse Gold Bars", "100 oz Silver Bars", "Gold IRA Products"],
  },
  {
    slug: "hawaii",
    name: "Hawaii",
    ...
    capital: "Honolulu",
    majorCities: ["Honolulu", "Pearl City", "Hilo", "Kailua", "Waipahu", "Kaneohe"],
    salesTax: "taxable",
    salesTaxNote: "Hawaii imposes a General Excise Tax (GET) of 4% on most business transactions, including precious metals sales. The GET is technically a business privilege tax passed to consumers. Hawaii buyers should budget for approximately 4% GET on GoldBuller orders delivered to Hawaii addresses.",
    deliveryDays: "5–7 business days",
    stateTip: "Hawaii's GET applies at the 4% rate. Factor this cost into your comparison against local coin dealers, who also collect GET. For large purchases, the GET plus express international shipping makes wire payment particularly important to minimize total cost — wire eliminates the 3.5% card surcharge.",
    localAngle: "Hawaii's high cost of living and inflation exposure make precious metals an appealing inflation hedge for residents. The state's international ties — particularly with Japan and other Asian markets where gold is culturally important — mean many Hawaii buyers are experienced gold investors. Shipping to Hawaii takes 5–7 business days via FedEx or UPS, fully insured.",
    popularProducts: ["American Gold Eagles (1 oz)", "PAMP Suisse Gold Bars", "Canadian Gold Maple Leafs", "American Silver Eagles"],
  },
  {
    slug: "idaho",
    name: "Idaho",
    ...
    capital: "Boise",
    majorCities: ["Boise", "Nampa", "Meridian", "Idaho Falls", "Pocatello", "Caldwell"],
    salesTax: "exempt",
    salesTaxNote: "Idaho exempts precious metals bullion and coins from sales tax under Idaho Code §63-3622S. The exemption applies to gold, silver, and platinum coins and bullion sold primarily for metal content value.",
    deliveryDays: "4–5 business days",
    stateTip: "Idaho is among the most pro-precious metals states in the West. The state also passed legislation recognizing gold and silver as legal tender in Idaho in 2024 — reinforcing the state's commitment to hard money principles.",
    localAngle: "Idaho's fast-growing Boise metro — driven by an influx of tech workers and remote workers from California — has created a young, financially aware demographic that views gold and silver as protection against inflation and monetary instability. Idaho's strong libertarian political culture also drives above-average precious metals interest per capita.",
    popularProducts: ["American Silver Eagles", "American Gold Eagles", "90% Junk Silver", "Silver Monster Boxes"],
  },
  {
    slug: "illinois",
    name: "Illinois",
    ...
    salesTax: "exempt",
    salesTaxNote: "Illinois imposes a reduced 1% sales tax on qualifying bullion and coins under 86 Ill. Admin. Code §130.120(c). Standard bullion products — gold and silver bars, bullion coins — qualify for the 1% reduced rate (vs. the standard 6.25% rate). This is not a full exemption, but nearly so.",
    deliveryDays: "2–3 business days",
    stateTip: "Illinois's 1% reduced rate on bullion is effectively negligible — on a $3,000 gold purchase, the tax is $30 vs. $188 at the full 6.25% rate. For wire payments, the savings from eliminating the card surcharge (3.5% = $105) far exceed the 1% tax on the order.",
    localAngle: "Chicago is the US home of the CME Group (formerly COMEX-linked futures markets) and a major financial hub. The Chicago metro's large financial services and professional class creates sophisticated demand for physical gold as portfolio diversification. Wire transfers are the dominant payment method for Chicago-area institutional buyers.",
    popularProducts: ["10 oz Gold Bars", "1 oz Gold Bars (PAMP)", "American Silver Eagles", "100 oz Silver Bars"],
  },
  {
    slug: "indiana",
    name: "Indiana",
    ...
    salesTax: "exempt",
    salesTaxNote: "Indiana exempts investment metal bullion from sales tax under IC 6-2.5-5-47(b). Investment metal bullion means a bar, ingot, or coin composed of gold, silver, platinum, or palladium that is sold based primarily on its metal content rather than its form.",
    deliveryDays: "2–3 business days",
    stateTip: "Indiana's exemption is explicitly tied to items 'sold based primarily on metal content' — standard bullion products (Eagles, Maples, bars from recognized refiners) clearly qualify. Numismatic coins sold at a significant premium over metal content would not qualify.",
    localAngle: "Indianapolis's growing financial and tech sector, combined with Indiana's manufacturing heritage, creates a strong middle-class investor base drawn to tangible assets. Indiana has a flat 3.15% state income tax — gold and silver gains are subject to this rate plus federal rates, making long-term holding strategies particularly effective.",
    popularProducts: ["American Silver Eagles", "American Gold Eagles", "90% Junk Silver", "100 oz Silver Bars"],
  },
  {
    slug: "iowa",
    ...
    salesTax: "exempt",
    salesTaxNote: "Iowa exempts gold, silver, and platinum bullion coins and bars from sales tax under Iowa Code §422B.3(2)(d). Iowa passed its precious metals exemption to align with neighboring states and encourage local investment in hard assets.",
    deliveryDays: "2–3 business days",
    stateTip: "Iowa's exemption covers coins and bullion without a minimum purchase threshold. Both government and private mint products qualify as long as they are sold for their metal content. Standard GoldBuller products — Eagles, Maples, PAMP bars — all qualify.",
    localAngle: "Iowa's agricultural economy creates natural affinity for tangible assets and commodity-linked investments. Farming communities historically view physical gold and silver as reliable stores of value across economic cycles. Des Moines' growing insurance and financial services sector adds a professional investor demographic.",
    popularProducts: ["American Gold Eagles", "American Silver Eagles", "90% Junk Silver", "100 oz Silver Bars"],
  },
  {
    slug: "kansas",
    name: "Kansas",
    ...
    salesTax: "exempt",
    salesTaxNote: "Kansas exempts precious metals bullion from sales tax effective July 2023 under SB 488, codified at K.S.A. §79-3606. Gold, silver, platinum, and palladium coins and bars sold primarily for metal content are fully exempt.",
    deliveryDays: "1–2 business days",
    stateTip: "Kansas's exemption took effect in 2023 — one of the more recent states to expand precious metals tax treatment. The exemption is comprehensive: all four metals, no minimum threshold, all recognized bullion formats. Kansas City metro (Overland Park, Olathe) receives GoldBuller shipments within 1–2 business days from Dallas.",
    localAngle: "Kansas's position as a central US agricultural state, combined with Wichita's aerospace and defense manufacturing base, creates demand for gold and silver as inflation-resistant savings. The Kansas City metro area straddles the Kansas-Missouri border — a significant financial and logistics hub.",
    popularProducts: ["American Gold Eagles", "American Silver Eagles", "100 oz Silver Bars", "PAMP Gold Bars"],
  },
  {
    slug: "kentucky",
    name: "Kentucky",
    ...
    capital: "Frankfort",
    majorCities: ["Louisville", "Lexington", "Bowling Green", "Owensboro", "Covington", "Elizabethtown"],
    salesTax: "exempt",
    salesTaxNote: "Kentucky exempts precious metals bullion from sales tax effective 2023 under HB 348, codified at KRS 139.480(25). Gold, silver, platinum, and palladium coins and bars sold primarily for metal content value are fully exempt from Kentucky's 6% sales tax.",
    deliveryDays: "2–3 business days",
    stateTip: "Kentucky's 2023 exemption is new and comprehensive — covering all four metals without a minimum purchase threshold. Louisville and Lexington-area buyers typically receive shipments from Dallas in 2 business days.",
    localAngle: "Kentucky's economy — anchored by bourbon, horses, healthcare, and logistics — has a strong entrepreneurial and wealth-creation culture. Louisville's UPS Worldport hub means the city is one of the best-connected shipping nodes in the US — ironically accelerating GoldBuller deliveries to Kentucky buyers.",
    popularProducts: ["American Gold Eagles", "American Silver Eagles", "90% Junk Silver", "PAMP Gold Bars"],
  },
  {
    slug: "louisiana",
    name: "Louisiana",
    ...
    capital: "Baton Rouge",
    majorCities: ["New Orleans", "Baton Rouge", "Shreveport", "Metairie", "Lafayette", "Lake Charles"],
    salesTax: "exempt",
    salesTaxNote: "Louisiana exempts gold, silver, and platinum coins and bullion from state sales tax under La. R.S. 47:305(D)(1)(f). The exemption applies to coins and bars sold primarily for their metal content. Note: Louisiana's parishes may levy local sales tax — state-level exemption covers the 4.45% state rate.",
    deliveryDays: "1–2 business days",
    stateTip: "Louisiana is among GoldBuller's fastest delivery destinations — shipping from Dallas to New Orleans, Baton Rouge, and Shreveport typically arrives next business day. While the state exemption covers 4.45%, some parishes collect local sales tax — verify your parish's treatment for large purchases.",
    localAngle: "Louisiana's oil and gas economy creates natural affinity for commodity investments including precious metals. New Orleans has a historically sophisticated financial culture with strong demand for tangible wealth storage. Louisiana's unique cultural relationship with jewelry and gold (particularly during Mardi Gras season) drives consumer awareness of gold as a value store.",
    popularProducts: ["American Gold Eagles", "100 oz Silver Bars", "American Silver Eagles", "Gold Bars (1 oz, PAMP)"],
  },
  {
    slug: "maine",
    name: "Maine",
    ...
    salesTax: "exempt",
    salesTaxNote: "Maine exempts precious metals bullion transactions over $1,000 from sales tax under 36 M.R.S. §1752(17-B). Purchases of gold, silver, or platinum coins or bullion valued at $1,000 or more per transaction are fully exempt. Smaller purchases may be subject to Maine's 5.5% rate.",
    deliveryDays: "4–5 business days",
    stateTip: "Maine's $1,000 threshold is easily cleared by most standard gold purchases. For silver, grouping multiple 10 oz bars or a 100 oz bar order into a single transaction clears the threshold. Keep orders over $1,000 per transaction to maintain the exemption.",
    localAngle: "Maine's relatively affluent professional and retiree population — concentrated in the Portland metro — drives demand for gold as a wealth preservation tool. Maine's no-nonsense Yankee culture aligns well with physical precious metals as straightforward, tangible savings.",
    popularProducts: ["American Gold Eagles", "American Silver Eagles", "PAMP Gold Bars", "100 oz Silver Bars"],
  },
  {
    slug: "maryland",
    name: "Maryland",
    ...
    salesTax: "exempt",
    salesTaxNote: "Maryland exempts precious metal bullion from sales tax under Md. Code Ann., Tax-Gen. §11-209(d). The exemption covers gold, silver, and platinum bullion in bar, coin, or ingot form sold primarily for metal content. Maryland's standard sales tax rate of 6% is fully avoided on qualifying bullion purchases.",
    deliveryDays: "3–4 business days",
    stateTip: "Maryland's full exemption has no minimum purchase threshold — covering all standard bullion products at any quantity. Baltimore-area buyers typically receive shipments in 3 business days from Dallas. The DC suburbs (Rockville, Gaithersburg) may see 3–4 business days.",
    localAngle: "Maryland's proximity to Washington DC creates one of the highest concentrations of federal government contractors, lawyers, and defense professionals in the US — a demographic with strong purchasing power and interest in asset diversification. The Baltimore-DC corridor has a high density of financial professionals who understand gold as a portfolio hedge.",
  ...
  },
  {
    ...
    salesTax: "taxable",
    salesTaxNote: "Massachusetts applies its 6.25% sales tax to most precious metals bullion purchases. Certain coins issued as legal tender may qualify for reduced treatment, but standard gold and silver bars are generally taxable under Massachusetts law. Buyers should verify current DOR guidance for specific products.",
    deliveryDays: "3–4 business days",
    stateTip: "While Massachusetts applies sales tax to most bullion, GoldBuller's wire payment option eliminates the 3.5% card surcharge — partially offsetting the tax cost. On a $5,000 order, wire saves $175 in surcharges. For IRA-eligible purchases through a custodian, sales tax treatment may differ.",
    localAngle: "Massachusetts — particularly the Boston and Cambridge metro — is a major financial, biotech, and academic hub with one of the highest concentrations of HNW households in the US. Despite the sales tax, demand for gold and silver as portfolio diversification is strong among Boston's financial and technology professional community. Boston is home to several major institutional gold buyers.",
    popularProducts: ["American Gold Eagles", "PAMP Suisse Gold Bars", "Gold IRA Products", "Platinum Eagles"],
  },
  {
    slug: "minnesota",
    name: "Minnesota",
    ...
    capital: "Saint Paul",
    majorCities: ["Minneapolis", "Saint Paul", "Rochester", "Duluth", "Brooklyn Park", "Bloomington"],
    salesTax: "exempt",
    salesTaxNote: "Minnesota exempts gold, silver, and platinum bullion and coins from sales tax under Minn. Stat. §297A.67(18). The exemption covers coins and bullion sold primarily for their metal content value, including government and private mint products.",
    deliveryDays: "2–3 business days",
    stateTip: "Minnesota's exemption is comprehensive — covering all four precious metals including palladium under the state's statutory definition. Standard bullion from any recognized mint qualifies. Minneapolis metro buyers typically receive in 2–3 business days.",
    localAngle: "Minnesota's diversified economy — including financial services, healthcare (Mayo Clinic), and technology — creates a well-educated, higher-income professional demographic interested in portfolio diversification. The Twin Cities metro has a strong tradition of retirement planning, and gold IRAs are particularly popular among Minnesota buyers.",
    popularProducts: ["American Gold Eagles", "American Silver Eagles", "Gold IRA Products", "PAMP Suisse Gold Bars"],
  },
  {
    slug: "mississippi",
    name: "Mississippi",
    ...
    capital: "Jackson",
    majorCities: ["Jackson", "Gulfport", "Southaven", "Hattiesburg", "Biloxi", "Meridian"],
    salesTax: "taxable",
    salesTaxNote: "Mississippi applies its 7% state sales tax to precious metals bullion purchases. Mississippi does not currently provide a specific exemption for gold, silver, or platinum bullion. Mississippi buyers should budget for the 7% tax on GoldBuller orders — verify current DOR rules for specific products.",
    deliveryDays: "1–2 business days",
    stateTip: "Even with Mississippi's 7% sales tax, bank wire payment saves the 3.5% card surcharge, reducing the total premium significantly. On a $3,000 silver order: wire saves $105 in surcharges. Mississippi is also one of GoldBuller's fastest delivery destinations — Jackson receives shipments from Dallas in 1–2 business days.",
    localAngle: "Mississippi's Gulf Coast — including Biloxi, Gulfport, and Pascagoula — has a significant maritime, gaming, and industrial economy. The Southaven/Memphis-area DeSoto County market draws on the broader mid-South buyer base. Mississippi buyers increasingly purchase silver over gold as a more accessible entry point.",
    popularProducts: ["American Silver Eagles", "90% Junk Silver", "100 oz Silver Bars", "American Gold Eagles"],
  },
  {
    slug: "missouri",
    name: "Missouri",
    ...
    salesTax: "exempt",
    salesTaxNote: "Missouri exempts gold, silver, and platinum bullion from sales tax under RSMo §144.030.2(45). The exemption covers coins, bars, and rounds composed of precious metals and sold primarily for their metal content value.",
    deliveryDays: "1–2 business days",
    stateTip: "Missouri's exemption is comprehensive with no minimum threshold. Kansas City and St. Louis — Missouri's two major metros — receive GoldBuller shipments from Dallas in 1–2 business days, making Missouri one of the fastest delivery windows in the US.",
    localAngle: "Missouri's dual-metro structure (Kansas City metro straddles the KS-MO border; St. Louis borders Illinois) creates two distinct buyer markets. Kansas City's financial and logistics sector drives professional gold buyers; St. Louis's pharmaceutical and biotech concentration adds a technical professional demographic. Missouri's central location also makes it a hub for regional coin dealers.",
    popularProducts: ["American Gold Eagles", "100 oz Silver Bars", "American Silver Eagles", "Gold Bars (10 oz)"],
  },
  {
    slug: "montana",
    name: "Montana",
    ...
    capital: "Helena",
    majorCities: ["Billings", "Missoula", "Great Falls", "Bozeman", "Butte", "Helena"],
    salesTax: "exempt",
    salesTaxNote: "Montana has no statewide sales tax — making all purchases, including precious metals, completely sales-tax-free at the state level. Montana is one of five US states with no sales tax, and also has no local sales tax structure. Montana additionally has no income tax on capital gains at rates above the standard personal income rate.",
    deliveryDays: "3–5 business days",
    stateTip: "Montana's no-sales-tax status is absolute and uniform — no local sales taxes exist in Montana. Bozeman and Billings-area buyers receive in approximately 3 business days; more remote Montana locations may take 4–5 business days.",
    localAngle: "Montana's Bozeman metro has seen rapid growth from out-of-state remote workers and tech professionals — creating a new demographic of financially sophisticated buyers in what was traditionally an agricultural state. Montana's resource economy (mining, ranching) and libertarian political culture create strong affinity for physical precious metals.",
    popularProducts: ["American Gold Eagles", "American Silver Eagles", "90% Junk Silver", "Gold Rounds (1 oz)"],
  },
  {
    slug: "nebraska",
    name: "Nebraska",
    ...
    population: "2.0 million",
    capital: "Lincoln",
    majorCities: ["Omaha", "Lincoln", "Bellevue", "Grand Island", "Kearney", "Fremont"],
    salesTax: "taxable",
    salesTaxNote: "Nebraska applies its 5.5% state sales tax to most precious metals bullion purchases. Nebraska does not provide a broad exemption for gold or silver bullion. Certain legal tender coins may receive different treatment — consult Nebraska DOR guidance for specific products before purchase.",
    deliveryDays: "2–3 business days",
    stateTip: "Nebraska's 5.5% sales tax applies to most bullion, but bank wire eliminates the 3.5% card surcharge — reducing the total extra cost to 5.5% vs. 9% if paying by card. Omaha and Lincoln buyers receive GoldBuller shipments within 2 business days from Dallas.",
    localAngle: "Omaha — home to Berkshire Hathaway and a major financial services concentration — has a sophisticated investment culture. Omaha investors, including those influenced by Warren Buffett's value investing principles, sometimes choose gold as a counter-cyclical portfolio anchor. Nebraska's agricultural economy also drives traditional hard-asset investment thinking.",
    popularProducts: ["American Gold Eagles", "American Silver Eagles", "100 oz Silver Bars", "PAMP Suisse Gold"],
  },
  {
    slug: "nevada",
    name: "Nevada",
    ...
    salesTax: "taxable",
    salesTaxNote: "Nevada applies sales tax to precious metals bullion purchases. Nevada's base state sales tax rate is 6.85%, and combined rates in Clark County (Las Vegas) reach 8.375%. Nevada does not provide a specific exemption for gold or silver bullion. Consult Nevada DOR guidance for specific product categories.",
    deliveryDays: "3–4 business days",
    stateTip: "Nevada has no state personal income tax — meaning gold and silver gains are subject only to federal capital gains tax, not any state income tax. This partially offsets the sales tax cost for long-term holders. Las Vegas buyers typically receive GoldBuller shipments in 3 business days.",
    localAngle: "Nevada's lack of personal income tax and strong entrepreneurial culture make it a significant precious metals market. Las Vegas and Henderson — with a large number of self-employed business owners and financial professionals — drive consistent demand. The Reno/Sparks technology corridor, hosting Tesla's Gigafactory and other tech facilities, adds a tech-professional buyer segment.",
    popularProducts: ["American Gold Eagles", "Silver Monster Boxes", "PAMP Gold Bars", "American Silver Eagles"],
  },
  {
    slug: "new-hampshire",
    name: "New Hampshire",
    ...
    population: "1.4 million",
    capital: "Concord",
    majorCities: ["Manchester", "Nashua", "Concord", "Dover", "Rochester", "Salem"],
    salesTax: "exempt",
    salesTaxNote: "New Hampshire has no statewide sales tax — all purchases, including precious metals, are completely sales-tax-free. New Hampshire is one of five US states with no sales tax, and also has no state income tax on wages, capital gains, or dividends (only interest and dividends are taxed, and that tax is being phased out).",
    deliveryDays: "3–4 business days",
    stateTip: "New Hampshire combines no sales tax with effectively zero state tax on capital gains — making it one of the most favorable states in the US for buying AND selling precious metals. Manchester and Nashua buyers receive GoldBuller shipments in approximately 3–4 business days from Dallas.",
    localAngle: "New Hampshire's 'Live Free or Die' culture aligns strongly with physical precious metals ownership as a financial independence strategy. The state's growing southern tier (Manchester, Nashua) draws significant population from Massachusetts — many buyers migrate to NH specifically for the tax advantages on investments including gold and silver.",
    popularProducts: ["American Gold Eagles", "American Silver Eagles", "Silver Monster Boxes", "90% Junk Silver"],
  },
  {
    slug: "new-jersey",
    name: "New Jersey",
    ...
    salesTax: "taxable",
    salesTaxNote: "New Jersey applies its 6.625% sales tax to precious metals bullion in most cases. NJ does not provide a comprehensive exemption for gold or silver bars and coins. Certain coins issued as US legal tender may receive different treatment — consult NJ Division of Taxation guidance for your specific purchase.",
    deliveryDays: "3–4 business days",
    stateTip: "New Jersey's sales tax applies to most bullion, but wire payment eliminates the 3.5% card surcharge — reducing the effective premium gap. New Jersey also taxes investment gains at state income tax rates up to 10.75% — making tax-efficient structures (Gold IRA, long-term holding) important for NJ buyers.",
    localAngle: "New Jersey's dense proximity to New York City means many NJ buyers are financial professionals and HNW individuals who use GoldBuller as an alternative to NYC coin dealers. The Newark/Jersey City financial district proximity drives demand for larger gold bar purchases. Wire payment is standard for this buyer demographic.",
    popularProducts: ["PAMP Suisse Gold Bars", "10 oz Gold Bars", "American Gold Eagles", "Platinum Eagles (IRA)"],
  },
  {
    slug: "new-mexico",
    name: "New Mexico",
    ...
    salesTax: "taxable",
    salesTaxNote: "New Mexico applies its Gross Receipts Tax (GRT) — effectively a sales tax — to precious metals purchases. The combined state and local GRT ranges from 5.125% to over 9% depending on municipality. New Mexico does not provide a comprehensive bullion exemption under current law.",
    deliveryDays: "2–3 business days",
    stateTip: "New Mexico's GRT applies to most bullion, but Albuquerque and Las Cruces buyers benefit from fast delivery — 2–3 business days from Dallas. Bank wire payment eliminates the 3.5% card surcharge, reducing the total extra cost despite the GRT.",
    localAngle: "New Mexico's energy economy (oil, gas, and nuclear) and proximity to the Texas Permian Basin creates a significant HNW buyer market in the southeastern part of the state. Santa Fe's art and culture economy also creates demand from high-income retirees and second-home owners seeking tangible asset diversification.",
    popularProducts: ["American Gold Eagles", "American Silver Eagles", "100 oz Silver Bars", "Gold Rounds (1 oz)"],
  },
  {
    slug: "north-carolina",
    name: "North Carolina",
    ...
    salesTax: "exempt",
    salesTaxNote: "North Carolina exempts precious metals bullion from sales tax effective January 2023 under S.L. 2021-169, codified at N.C. Gen. Stat. §105-164.13(63). The exemption covers gold, silver, platinum, and palladium coins and bullion sold primarily for metal content.",
    deliveryDays: "2–3 business days",
    stateTip: "North Carolina's 2023 exemption is comprehensive — covering all four metals without a minimum purchase threshold. Charlotte and Raleigh-Durham buyers typically receive GoldBuller shipments in 2 business days. The Research Triangle's tech demographic is a fast-growing segment of NC gold buyers.",
    localAngle: "North Carolina is home to two of the fastest-growing major metros in the US: Charlotte (a major banking hub) and the Raleigh-Durham Research Triangle (biotech and tech). Charlotte's financial services concentration — Bank of America headquarters, major regional banks — creates a sophisticated institutional and retail buyer market for gold and silver.",
  ...
  },
  {
    ...
    salesTax: "exempt",
    salesTaxNote: "North Dakota exempts precious metals bullion and coins from sales tax under NDCC §57-39.2-04(34). The exemption applies to gold, silver, platinum, and palladium coins and bullion sold primarily for metal content value.",
    deliveryDays: "3–4 business days",
    stateTip: "North Dakota's oil boom (Bakken Shale) has created significant per-capita wealth in the western part of the state. Williston and Minot buyers in the oil patch may prefer larger gold orders as a store for commodity-cycle income. Fargo buyers — closer to Minneapolis — receive shipments in 3 business days.",
    localAngle: "North Dakota's energy economy — the Bakken Shale oil fields in the western part of the state — creates significant wealth concentrated among oil workers and landowners. Precious metals are a natural fit for storing commodity-cycle income in a durable, transportable form. Fargo's growing financial and tech sector adds a professional buyer demographic.",
    popularProducts: ["American Gold Eagles", "100 oz Silver Bars", "American Silver Eagles", "Gold Bars (10 oz)"],
  },
  {
    slug: "oklahoma",
    ...
    majorCities: ["Oklahoma City", "Tulsa", "Norman", "Broken Arrow", "Lawton", "Edmond"],
    salesTax: "exempt",
    salesTaxNote: "Oklahoma exempts sales of gold, silver, platinum, and palladium bullion and coins from sales tax under Okla. Stat. §68-1357(12). The exemption applies to coins and bullion sold primarily for metal content rather than numismatic or collectible value.",
    deliveryDays: "1–2 business days",
    stateTip: "Oklahoma is one of GoldBuller's closest delivery destinations — shipping from Dallas to Oklahoma City and Tulsa typically arrives the next business day. Oklahoma's full precious metals exemption with no minimum threshold makes it one of the most favorable states in the region.",
    localAngle: "Oklahoma's energy economy — oil, gas, and increasingly wind power — creates significant per-capita wealth among landowners and energy professionals. Tulsa's financial district and Oklahoma City's growing tech sector add professional buyers seeking gold as an inflation hedge against energy-price volatility. Wire payment is common in Oklahoma's energy business culture.",
    popularProducts: ["American Gold Eagles", "100 oz Silver Bars", "American Silver Eagles", "PAMP Gold Bars"],
  },
  {
    slug: "oregon",
    name: "Oregon",
    ...
    salesTax: "exempt",
    salesTaxNote: "Oregon has no statewide sales tax — making all purchases, including precious metals, completely tax-free at the state level. Oregon is one of five US states with no sales tax. Note: Oregon does have a state income tax, so capital gains from selling gold are subject to Oregon state income tax (up to 9.9%).",
    deliveryDays: "4–5 business days",
    stateTip: "Oregon's no-sales-tax status makes buying gold and silver seamlessly cost-effective. However, Oregon's high state income tax (up to 9.9%) means sellers of appreciated gold should plan tax-efficient exit strategies. For IRA purchases, the Oregon income tax on distributions from non-Roth IRAs should also be factored.",
    localAngle: "Portland's tech sector — home to Nike, Intel, and a growing startup community — creates demand from high-income professionals seeking inflation hedges. Oregon's self-reliant, outdoor culture also drives interest in physical precious metals as a financial independence tool. The Portland metro is one of the stronger precious metals markets in the Pacific Northwest.",
    popularProducts: ["American Gold Eagles", "American Silver Eagles", "PAMP Gold Bars", "Bitcoin-to-Gold conversions"],
  },
  {
    slug: "rhode-island",
    name: "Rhode Island",
    ...
    population: "1.1 million",
    capital: "Providence",
    majorCities: ["Providence", "Cranston", "Warwick", "Pawtucket", "East Providence", "Woonsocket"],
    salesTax: "exempt",
    salesTaxNote: "Rhode Island exempts precious metals bullion and coins from sales tax under R.I. Gen. Laws §44-18-30(55). Gold, silver, and platinum coins and bullion sold primarily for metal content are fully exempt from Rhode Island's 7% sales tax rate.",
    deliveryDays: "3–4 business days",
    stateTip: "Rhode Island's full exemption saves buyers 7% on the state's relatively high sales tax rate — one of the larger exemption values in the Northeast. Providence buyers receive GoldBuller shipments in approximately 3–4 business days from Dallas.",
    localAngle: "Rhode Island's small size belies its financial sophistication — Providence hosts significant financial services firms, and the state's proximity to Boston brings many high-income professionals into the precious metals market. Rhode Island's $15,000 median household income premium over the national average creates a buyer demographic with meaningful disposable investment capital.",
    popularProducts: ["American Gold Eagles", "PAMP Suisse Gold Bars", "American Silver Eagles", "100 oz Silver Bars"],
  },
  {
    slug: "south-carolina",
    name: "South Carolina",
    ...
    capital: "Columbia",
    majorCities: ["Columbia", "Charleston", "North Charleston", "Mount Pleasant", "Rock Hill", "Greenville"],
    salesTax: "exempt",
    salesTaxNote: "South Carolina exempts precious metals bullion from sales tax under S.C. Code §12-36-2120(42). Gold, silver, and platinum coins and bars sold primarily for metal content are fully exempt from South Carolina's 6% sales tax.",
    deliveryDays: "2–3 business days",
    stateTip: "South Carolina's full exemption with no minimum threshold covers all standard bullion products. Charleston and Columbia buyers receive GoldBuller shipments in 2–3 business days from Dallas. Greenville's growing automotive and manufacturing sector creates a strong professional buyer base.",
    localAngle: "South Carolina's growing economy — driven by BMW, Boeing, and Volvo manufacturing facilities — has created a diversified professional class with above-average income. Charleston's historic financial culture and growing tech scene adds a sophisticated buyer demographic. South Carolina also has no state income tax on Social Security benefits, making it popular with retirees who use gold for wealth preservation.",
  ...
  },
  {
    ...
    salesTax: "exempt",
    salesTaxNote: "South Dakota exempts precious metals bullion from sales tax. South Dakota has also been a leader in financial services legislation — the state has no corporate income tax, no personal income tax, and no inheritance tax, making it one of the most favorable states for wealth accumulation.",
    deliveryDays: "2–3 business days",
    stateTip: "South Dakota's combination of no sales tax on bullion, no personal income tax, and no inheritance tax makes it one of the most favorable states in the US for buying, holding, and transferring precious metals wealth. Sioux Falls and Rapid City buyers receive GoldBuller shipments in 2–3 business days.",
    localAngle: "South Dakota's financial services hub in Sioux Falls — driven by the state's business-friendly banking regulations — creates a disproportionately large financial services sector for a small state. Rapid City serves the Black Hills mining region, which has historical affinity for precious metals. Mount Rushmore gold and silver coins are particularly popular with South Dakota buyers.",
    popularProducts: ["American Gold Eagles", "American Silver Eagles", "Gold Buffalo Coins", "100 oz Silver Bars"],
  },
  {
    slug: "tennessee",
    name: "Tennessee",
    ...
    salesTax: "taxable",
    salesTaxNote: "Tennessee applies sales tax to most precious metals bullion purchases. While Tennessee exempts certain legal tender coins under specific conditions, gold and silver bars and rounds are generally subject to Tennessee's 7% state sales tax plus applicable local rates. Verify current Tennessee DOR guidance for your specific products.",
    deliveryDays: "2–3 business days",
    stateTip: "Tennessee has no state income tax — meaning any appreciation in gold and silver is subject only to federal capital gains tax, not state tax. This partially compensates for the sales tax cost on purchase. Nashville and Memphis buyers receive GoldBuller shipments in 2–3 business days from Dallas.",
    localAngle: "Tennessee's rapid growth — Nashville has been one of the fastest-growing cities in the US for over a decade — has created significant new wealth and demand for hard-asset investment. Tennessee's no-income-tax status makes it a popular destination for high earners, who frequently seek gold and silver for portfolio diversification. The state's strong entrepreneurial culture in Nashville and Knoxville's tech scene add active buyer demographics.",
    popularProducts: ["American Gold Eagles", "American Silver Eagles", "PAMP Gold Bars", "100 oz Silver Bars"],
  },
  {
    slug: "utah",
    ...
    salesTax: "exempt",
    salesTaxNote: "Utah exempts precious metals bullion and coins from sales tax under Utah Code §59-12-104(28). The exemption applies to gold, silver, and platinum coins and bullion sold primarily for metal content. Utah was one of the first states to formally recognize gold and silver as legal tender alongside US currency.",
    deliveryDays: "3–4 business days",
    stateTip: "Utah's precious metals exemption is broad and well-established. Utah also legally recognizes gold and silver as constitutional money — the Gold and Silver Legal Tender Act (2011) — making Utah one of the most legally gold-friendly states in the US. Salt Lake City buyers receive GoldBuller shipments in 3–4 business days.",
    localAngle: "Utah's tech sector (Silicon Slopes in the Salt Lake/Provo corridor) has created a large demographic of young, financially literate professionals interested in sound money. Utah's religious culture also historically emphasizes self-sufficiency and tangible asset accumulation. Utah has a flat 4.55% income tax — gold gains are taxed at this rate at the state level.",
    popularProducts: ["American Gold Eagles", "Silver Monster Boxes", "American Silver Eagles", "Gold Buffalo Coins"],
  },
  {
    slug: "vermont",
    name: "Vermont",
    ...
    capital: "Montpelier",
    majorCities: ["Burlington", "South Burlington", "Rutland", "Barre", "Montpelier", "Winooski"],
    salesTax: "taxable",
    salesTaxNote: "Vermont applies its 6% sales tax to precious metals bullion purchases in most cases. Vermont does not provide a comprehensive exemption for gold or silver bars and coins under current law. Vermont buyers should budget for approximately 6% sales tax on bullion orders.",
    deliveryDays: "4–5 business days",
    stateTip: "Vermont's sales tax applies to most bullion, but wire payment eliminates the 3.5% card surcharge — reducing the effective additional cost. Vermont is one of the more remote delivery destinations from Dallas — Burlington and Montpelier typically see 4–5 business days transit time.",
    localAngle: "Vermont's small population belies a relatively affluent professional and retiree demographic concentrated around Burlington. The state's artisan economy and self-reliant culture create interest in physical gold and silver as alternatives to conventional financial assets. Vermont's proximity to Quebec, Canada also creates some cross-border buyer interest.",
    popularProducts: ["American Gold Eagles", "American Silver Eagles", "Canadian Gold Maple Leafs", "PAMP Gold Bars"],
  },
  {
    slug: "virginia",
    name: "Virginia",
    ...
    capital: "Richmond",
    majorCities: ["Virginia Beach", "Norfolk", "Chesapeake", "Arlington", "Richmond", "Newport News"],
    salesTax: "exempt",
    salesTaxNote: "Virginia exempts precious metals bullion and coins from sales tax under Va. Code §58.1-609.1(6). Gold, silver, and platinum coins and bullion sold primarily for metal content are exempt from Virginia's 5.3% state sales tax and local add-ons.",
    deliveryDays: "3–4 business days",
    stateTip: "Virginia's full exemption covers all standard bullion products without a minimum purchase threshold. Northern Virginia (Arlington, Alexandria, Fairfax) buyers may see 3–4 business days from Dallas; Hampton Roads buyers (Virginia Beach, Norfolk) typically see 3–4 days as well.",
    localAngle: "Northern Virginia — home to Amazon HQ2, Booz Allen Hamilton, SAIC, and thousands of federal contractors — has one of the highest concentrations of high-income professionals in the US. This demographic drives strong demand for gold and silver as inflation hedges and portfolio diversifiers. Virginia's full precious metals exemption combined with this buyer profile makes it one of GoldBuller's strongest markets on the East Coast.",
    popularProducts: ["PAMP Suisse Gold Bars", "American Gold Eagles", "Gold IRA Products", "Platinum Eagles"],
  },
  {
    slug: "west-virginia",
    name: "West Virginia",
    ...
    capital: "Charleston",
    majorCities: ["Charleston", "Huntington", "Morgantown", "Parkersburg", "Wheeling", "Martinsburg"],
    salesTax: "exempt",
    salesTaxNote: "West Virginia exempts precious metals bullion and coins from sales tax under W. Va. Code §11-15-9(a)(17). Gold, silver, and platinum bullion sold primarily for metal content value is exempt from West Virginia's 6% state sales tax.",
    deliveryDays: "2–3 business days",
    stateTip: "West Virginia's full exemption covers standard bullion products without a minimum threshold. Charleston and Huntington buyers receive GoldBuller shipments in approximately 2–3 business days from Dallas. Morgantown (near Pittsburgh) sees similar transit times.",
    localAngle: "West Virginia's coal and energy economy has historically created boom-and-bust income cycles — driving interest in physical gold and silver as a stable store of value across economic cycles. The Morgantown metro (West Virginia University) adds an educated professional demographic. West Virginia's proximity to the Pittsburgh and Washington DC metro areas creates cross-border buyer activity.",
    popularProducts: ["American Gold Eagles", "American Silver Eagles", "90% Junk Silver", "100 oz Silver Bars"],
  },
  {
    slug: "wisconsin",
    ...
    salesTax: "exempt",
    salesTaxNote: "Wisconsin exempts precious metals bullion and coins from sales tax under Wis. Stat. §77.54(7m). Gold, silver, and platinum coins and bullion sold primarily for metal content are fully exempt from Wisconsin's 5% state sales tax and local county taxes.",
    deliveryDays: "2–3 business days",
    stateTip: "Wisconsin's exemption is comprehensive — covering government and private mint products without a minimum threshold. Milwaukee and Madison buyers receive GoldBuller shipments in 2 business days from Dallas. Green Bay and Appleton buyers typically see 2–3 business days.",
    localAngle: "Wisconsin's diversified economy — manufacturing, dairy, financial services, and a strong university system — creates a broad middle-class buyer base for precious metals. Milwaukee's financial district and Madison's growing tech and biotech sector add professional buyers. Wisconsin's manufacturing heritage gives residents a natural affinity for tangible, physical assets.",
    popularProducts: ["American Silver Eagles", "American Gold Eagles", "90% Junk Silver", "100 oz Silver Bars"],
  },
  {
    slug: "wyoming",
    ...
    population: "0.6 million",
    capital: "Cheyenne",
    majorCities: ["Cheyenne", "Casper", "Laramie", "Gillette", "Rock Springs", "Sheridan"],
    salesTax: "exempt",
    salesTaxNote: "Wyoming exempts precious metals bullion and coins from sales tax under W.S. §39-15-105(a)(viii). Wyoming has no state income tax — meaning gold and silver gains are subject only to federal capital gains tax. Combined with the bullion sales tax exemption, Wyoming is one of the most favorable states in the US for precious metals investors.",
    deliveryDays: "3–4 business days",
    stateTip: "Wyoming combines precious metals sales tax exemption with zero state income tax — meaning buyers in Wyoming pay no state-level taxes on either the purchase of gold or the gains from selling it. Only federal taxes apply. Cheyenne buyers receive GoldBuller shipments in approximately 3 business days.",
    localAngle: "Wyoming's energy economy (oil, gas, coal) and growing cryptocurrency and digital assets sector (Wyoming has some of the most crypto-friendly legislation in the US) create a financially independent, hard-money culture. Wyoming's cryptocurrency legal framework — including the DAO LLC structure — has attracted tech and blockchain professionals, many of whom use GoldBuller to convert crypto profits into physical gold.",
    popularProducts: ["American Gold Eagles", "Bitcoin-to-Gold conversions", "American Silver Eagles", "Gold Buffalo Coins"],
  },
];
